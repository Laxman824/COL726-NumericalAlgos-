...
########################################################
# Q6. Implementation of LSI in Matlab using SVD. Verify 
#     whether SVD gives better clustering and noise 
#     reduction as compared to using the original matrix.
########################################################
...
########################################################
# Q7. Obtain W, R & Q using Householder reflections
########################################################
...
########################################################
# Q8. Solve Least Squares Problem via QR Factorization
########################################################
...
##########################################
# Q9. Solving Cartesian coordinate system
##########################################
